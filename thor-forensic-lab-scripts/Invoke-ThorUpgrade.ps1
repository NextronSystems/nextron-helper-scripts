...
if ($ThorUtil -eq $null)
{
	Write-Host (Get-Date).ToString("yyyy/MM/dd HH:mm:ss") "| Error: $thorUtilText not found in the current directory or its subdirectories"
	exit 1
}
else
{
	Write-Host (Get-Date).ToString("yyyy/MM/dd HH:mm:ss") "| Located $thorUtilText at $ThorUtil"
}

Start-Process -FilePath $ThorUtil -ArgumentList "upgrade"
Write-Host (Get-Date).ToString("yyyy/MM/dd HH:mm:ss") "| Upgrading $ThorUtil"

# SIG # Begin signature block
# MIIvngYJKoZIhvcNAQcCoIIvjzCCL4sCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBZ4+NQa8GyvR6Y
# WKsGrBz7HUCzT6A7Iv/FEZMryXFpxKCCKKMwggQyMIIDGqADAgECAgEBMA0GCSqG
...
# 8RLY6sLVjwRmFx03xLZQq40xxAzENJST+QU5rrhZ3DANBgkqhkiG9w0BAQEFAASC
# AgAg1GbYMr5Kivfnpv9+ITLLpLysrHwpwHG/v0MyZ2/fIuoGyS8mxcywbcI89AR1
# 2aQRuoD8P0LUlPpEIOafTXfmJt+7wZBtqsWwB3euk/QMl2/GzTK/bbqHhE6yGJfu
# k6d05WoYy++p4ijgI72AWrT3++SjB9LEon2w4oSutVkBFnDMstVAnhchyUX0Bp8V
# q1Cjmt9febnB9nq9ebcoUtf0yQUXaSWUMShyTg1uHl6ipdBVjkJWQFq+ncyr8S4e
# LzG7DA2dIsfipL3SUjAlOkBRLPWWFmSYTsXN2Z08QsDIFOLC+8mVcAZvtGfGwnVy
# +YJwFUAVHRjBXAEsfIlWjXuIVqzNdIFCSQxV9xDT4fePW3k1lqVd6++teXRQET8j
# HyYsePu7CAKciAP1B5KkFEp1Es7mq+fkWZ8O3UIrfC8Zp854mLvDgXzEJr1qIkCX
# aFeK4gmNKjXee+3aCCdP1YdjVZ3SP3kXn32UusJ2LEP1p9dyIXuWoIce2diqZdpd
# u5VWOmx0T6c1K0FJscTe3ORTQuk6pzM79HBtoE0xoPMAYq24WFr7aF1wZglG2DTo
# NnSgLymATkRJzB6fw+ZtnCqhaY/dPDQVig7hNJTUarX2JseogKcZ8skIQ9JEeKJh
# Q/2ykEH5xujPtWPfcnhpAvye//5blNLQi/AHjUuiIiVqcKGCA2wwggNoBgkqhkiG
...
# 9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgns8yI+kqWYYNAbSHJvTHJqqA1ILxbUiH
# 0eBB91JH/HIwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGOMIGLBBRE05OczRuIf4Z6
...
# AYB/UcCuK71jSRP+6M7WDI+SIS0GI1+wyPZuqEfhthXdI7FMdp/SI7sruMOr4K8e
# gcwSFpwZpaQwHVvOgwObzopgZKoTc4rI3CC6aDjwpRIOtZ21HhDikJdiSjmYWMa9
# P5NrIYDtVwwjUsMNvJO5YDBNavVKtw9iBS9oZX4f1bAg9Y0ZGCWbpo+yv8rKHXuy
# DqnkZWlrd6SctsArTaAXmbpDPvKduv53JE40+KFeNM0vCF63TEFNxnLlD/XB13dA
# zRFKFyGB93Tk7c/uPsXeWIHccsKvgDrvDLt0X+auBWSNhLLBYBMWRvYthEtHBktK
# S4Actj6ivRHJiKbkyAhKJbxllitpm7183tXsGk3NRACQ0r+cs+/PoFJK4Qj0Yg5t
# cbofPoqdg45YFjyjQrSPMve+K1Nh0zFWtzpWH7WYmNf1g3rNU+i0X3ZAqQc5uA8o
# sXgKYKxaOlziBilabn2N90hhdNGKvr8JxWWJb0Vmw6JFBVoBI2R1CD1V8woLDQjj
# EVI=
